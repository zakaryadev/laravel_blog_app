...
<head>
    <meta charset="utf-8">
    <title>{{ $title ?? 'FASTER - Logistics Company' }}</title>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 mb-5">
                        ...
                        <div class="d-flex flex-column justify-content-start">
                            <a class="text-white mb-2" href="{{ route('main') }}"><i
                            ...
                            <a class="text-white mb-2" href="{{ route('service') }}"><i
                                ...
                                Services</a>
                            <a class="text-white mb-2" href="{{ route('price') }}"><i
                                    class="fa fa-angle-right mr-2"></i>Pricing
                                Plan</a>
    ...
    <div class="container-fluid bg-dark text-white border-top py-4 px-sm-3 px-md-5"
        ...
        <div class="row">
            <div class="col-lg-6 text-center text-md-left mb-3 mb-md-0">
                <p class="m-0 text-white">&copy; <a href="/">Pátte</a>. All Rights Reserved</p>
            </div>
